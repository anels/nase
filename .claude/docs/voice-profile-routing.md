...
| `github-review-reply` | Review/comment rules + no-blame rules | For declines or reply-only threads, stay direct and non-defensive. Cite concrete evidence for this thread. Keep each reply at three lines or less. |
