...
- FSD delivery gates: `fsd-delivery-gates.md` owns the mandatory single final review covering both code quality and spec conformance, the shared QA state machine, PR, verification-matrix, KB controls, closure ledger, final report, and error handling.
