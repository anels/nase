...
**Early size signal:** if `affected_files` already exceeds ~15 files, say so now and name the natural split seams - cheaper to scope down before code intent locks in than at the Phase 6.1 final diff measurement.
