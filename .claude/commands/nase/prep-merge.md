...
outcome and must report every returned path plus up to 20 dirty items and any
omitted-item count. A verified-clean worktree is also retained as a locked
quarantine. Return `2` stops the workflow with the helper error.
