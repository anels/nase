...
assert_contains "re-review ping uses slack surface" ".claude/commands/nase/request-review.md" 'surface=slack-dm'
assert_contains "FSD delivery gates use PR body surface" ".claude/docs/fsd-pr-delivery.md" 'surface=github-pr-body'
