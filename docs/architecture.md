...
| `PreToolUse:Jira mutations` | Before Jira writes | `jira-write-guard.sh` | Requires a fresh `workspace/.jira-write-token`; publication, validation, atomic consumption, and audit logging share the repo-wide workspace mutation lock |
